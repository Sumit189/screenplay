...
// Allow connections only from localhost and local network IPs
const allowedOrigins = [
  "http://localhost:3762",
  "http://192.168.31.72:3762" // Your local network IP
];
...
// Add a route to check if server is alive
app.get('/', (req, res) => {
  res.send('Screen Share Server is Running');
});

// Add a route to get STUN/TURN servers
app.get('/api/ice-servers', (req, res) => {
  // You would typically fetch these from a service like Twilio or use your own TURN server
  res.json({
    iceServers: [
